...
const allPlans = ref([
  ...
  },
  {
    ...
    period: 'mensual',
    buttonText: 'Contratar',
    technicalTitle: 'Internet + Claro TV+',
  ...
  },
  {
    ...
    features: ['Controles parentales', 'Múltiples perfiles', 'Canales infantiles', 'App familiar'],
    category: 'Familiar',
  },
  {
    id: 12,

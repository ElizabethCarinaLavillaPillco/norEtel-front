    ...
    <main class="main-content">
      ...
      <div v-else-if="planData" class="details-container">
        ...
        <div class="details-header">
          ...
          <button @click="sharePlan" class="share-btn">
            🔗 Compartir
          </button>
        </div>
        ...
        <div class="details-content">
          ...
          <section class="hero-section">
            <div class="hero-content">
              ...
              <p class="plan-description">{{ planData.description || 'Plan de internet de alta calidad' }}</p>
            ...
            <div class="technical-grid">
              ...
              <div class="technical-card" v-if="planData.technicalDetails">
                ...
                <ul class="technical-list">
                  <li v-for="detail in planData.technicalDetails" :key="detail">
                    ✅ {{ detail }}
                  </li>
                </ul>
              </div>
              ...
              <div class="technical-card" v-if="planData.features">
                <h3>Incluye</h3>
                <ul class="technical-list">
                  <li v-for="feature in planData.features" :key="feature">
                    ⭐ {{ feature }}
                  </li>
                </ul>
              </div>
          ...
          <section class="cta-section">
            <div class="cta-content">
              ...
              <div class="cta-buttons">
                ...
                <button @click="goBack" class="btn-secondary-large">
                  Ver más planes
                </button>
              </div>
            </div>
...
.plan-badge.residencial { background: rgba(76, 175, 80, 0.3); }
.plan-badge.premium { background: rgba(255, 193, 7, 0.3); }
.plan-badge.empresarial { background: rgba(156, 39, 176, 0.3); }
.plan-badge.combo { background: rgba(255, 152, 0, 0.3); }
